...
struct CalendarView: View {
    ...
    private var metricsSection: some View {
        VStack(alignment: .leading, spacing: 10) {
            ...
            HStack(spacing: 15) {
                metricBox(icon: "flame.fill",
                          value: "\(activityViewModel.daysLearned)",
                          label: "Days Learned",
                          iconColor: .orange,
                          backgroundColor: .orange)

                metricBox(icon: "cube.fill",
                          value: "\(activityViewModel.daysFreezed)",
                          label: "Day Freezed",
    ...
    private func metricBox(icon: String, value: String, label: String,
                           iconColor: Color, backgroundColor: Color) -> some View {
        HStack {
